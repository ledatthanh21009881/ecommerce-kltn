...
export async function GET(
  ...
  try {
    ...
    const backendUrl = `${BACKEND_URL}/api/backend/v1/tracking/shippers/${shipperId}/location`
...
export async function POST(
  ...
  try {
    ...
    const backendUrl = `${BACKEND_URL}/api/backend/v1/shippers/${shipperId}/location`
